...
// Particle physics
const bool one_part = false; // debug mode with just one particle
...
// Wind info (refer to research paper linked in README)
...
// Bounce constants (refer to research paper linked in README)
